...
%%
%%  REVISION 3 — systematic response to second-round reviewer concerns:
%%    (P0) Fig.3 replaced with factual Sharpe bar chart (no constructed
%%         paths); Table 4 DV corrected to max(-CAR,0); GitHub note added
%%    (P1) IV exclusion restriction discussed; Table 4 sign convention
%%         unified with Assumption 1; stability-performance separability
%%    (P2) All 6 temporal pairs; raw attribution note; survivorship-bias
%%         method corrected; hyperparameter text fixed; citations updated
%% ============================================================
...
Cumulative monthly net return time series are available in the online
supplement.}
