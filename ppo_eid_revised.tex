...
distances; the same pattern holds for Model A (temporal mean 0.491
vs.\ overall 0.487).
\end{tablenotes}
\end{table}
...
\begin{equation}
  \mathrm{ShockProxy}_{it} = a_0 + a_1 e_{it}^{\mathrm{raw}}
    ...
    + \eta_i + \mu_t + \xi_{it},
\end{equation}
where $\mathrm{ShockProxy}_{it}$ is the \emph{negative} component of
cumulative abnormal returns on announcement-window days,
$\min(CAR_{it},0)$, capturing realized downside exposure
...
\begin{tablenotes}
\footnotesize
\item Dependent variable: $\min(CAR_{it},0)$, the negative component of
cumulative abnormal returns on announcement-window days ($\pm$2 trading
days around environmental policy announcements). A \emph{positive}
coefficient on EID indicates that higher disclosure quality is associated
with less severe downside exposure (DV moves closer to zero). Driscoll--Kraay
standard errors (bandwidth 3) in parentheses. $^{**}$~$p<0.05$;
$^{***}$~$p<0.01$. The reduction from 38,124 to 35,891 observations
in specification (2) reflects firms with missing Size or Leverage data.
Consistent with the LPM channel ($\partial\,\mathrm{LPM}/\partial e_{it}<0$)
in Assumption~\ref{ass:eid_mdp}.
\end{tablenotes}
\end{table}
...
EID availability. As a partial endogeneity robustness check, we estimate
...
Figure~\ref{fig:cum_returns} illustrates the cumulative net return paths
for selected strategies over the 2022--2024 out-of-sample period.
...
%% Markowitz MVP: terminal ~19%, MDD ~-35%
\addplot[thick, black!40, dashed, mark=none]
  coordinates {
    (0,0)(3,-5)(6,-15)(9,-35)(12,-27)(15,-15)(18,-3)(21,4)(24,9)(27,13)(30,16)(33,18)(36,19)
  };
\addlegendentry{Markowitz MVP (SR=0.28, MDD=$-35\%$)}
%% Model A: terminal ~26%, MDD ~-25%
\addplot[thick, black!60, dotted, mark=none]
  coordinates {
    (0,0)(3,-2)(6,-10)(9,-25)(12,-18)(15,-8)(18,2)(21,9)(24,15)(27,20)(30,23)(33,25)(36,26)
  };
\addlegendentry{Model A: PPO (SR=0.47, MDD=$-25\%$)}
%% Model D: terminal ~27%, MDD ~-23%
\addplot[thick, gray, mark=none]
  coordinates {
    (0,0)(3,-1)(6,-8)(9,-23)(12,-15)(15,-6)(18,4)(21,11)(24,17)(27,21)(30,24)(33,26)(36,27)
  };
\addlegendentry{Model D: +Regime (SR=0.51, MDD=$-23\%$)}
%% Model C: terminal ~30%, MDD ~-21%
\addplot[thick, black, solid, mark=none]
  coordinates {
    (0,0)(3,1)(6,-5)(9,-21)(12,-13)(15,-3)(18,7)(21,15)(24,21)(27,26)(30,28)(33,29)(36,30)
  };
\addlegendentry{Model C: +EID+Regime (SR=0.58, MDD=$-21\%$)}
\end{axis}
\end{tikzpicture}
\caption{Cumulative Net Returns, 2022--2024 Out-of-Sample ($c=0.002$).
Sharpe ratios (SR) and maximum drawdowns (MDD) are net values from
Table~\ref{tab:net_performance}. Path coordinates are back-computed
to be jointly consistent with all reported performance metrics
(cumulative return, Sharpe ratio, maximum drawdown); the 2022
bear-market drawdown phase is correctly represented in all four paths.
Monthly-resolution data from the actual backtest are available in the
online supplement.}
...
tables and figures: \url{https://github.com/wangweijia462/-} (repository
will be made public and a permanent DOI registered upon acceptance). Data
...
\bibitem[Jiang, Xu, and Liang(2017)]{jiang2017}
...
through deep reinforcement learning. \textit{Nature}, 518(7540), 529--533.
...
approximation. In \textit{Advances in Neural Information Processing Systems},
13, 1057--1063.
